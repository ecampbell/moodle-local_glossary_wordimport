...
$plugin->release = '1.1.7 (Build: 2025042300)'; // Human readable version information.
$plugin->dependencies = ['booktool_wordimport' => 2025042300]; // Requires Book Word import plugin.
