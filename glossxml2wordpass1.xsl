 ...
 * XSLT stylesheet to transform Moodle Glossary XML-formatted terms into Word-compatible HTML tables
 *
...
<!-- Convert Moodle release numbers such as "2.4" to "24" for easier numerical comparisons -->
...
<xsl:variable name="description_instructions">
    <xsl:choose>
    <xsl:when test="$moodle_release_number = '19'">
        <xsl:value-of select="$moodle_labels/data[@name = 'local_glossary_wordimport_description_instructions']"/>
    </xsl:when>
...
<xsl:variable name="essay_instructions">
    <xsl:choose>
    <xsl:when test="$moodle_release_number = '19'">
        <xsl:value-of select="$moodle_labels/data[@name = 'local_glossary_wordimport_essay_instructions']"/>
    </xsl:when>
...
<xsl:variable name="multichoice_instructions">
    <xsl:choose>
    <xsl:when test="$moodle_release_number = '19'">
        <xsl:value-of select="concat($moodle_labels/data[@name = 'local_glossary_wordimport_multichoice_instructions'], ' (MC/MA)')"/>
    </xsl:when>
...
<xsl:variable name="cloze_instructions" select="$moodle_labels/data[@name = 'local_glossary_wordimport_cloze_instructions']"/>
<xsl:variable name="truefalse_instructions" select="$moodle_labels/data[@name = 'local_glossary_wordimport_truefalse_instructions']"/>
<xsl:variable name="unsupported_instructions" select="$moodle_labels/data[@name = 'local_glossary_wordimport_unsupported_instructions']"/>
...
<xsl:template match="question">
    ...
    <tbody>
        ...
        <tr>
            ...
            <xsl:when test="$qtype = 'CL'">
                <p class="Cell">
                    <xsl:apply-templates select="$moodle_labels/data[@name = 'local_glossary_wordimport_cloze_instructions']"/>
                </p>
            </xsl:when>
            <xsl:otherwise>
