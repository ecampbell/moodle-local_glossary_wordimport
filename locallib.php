 ...
 */
function local_glossary_wordimport_convert_to_xhtml($filename, &$imagesforzipping) {
    global $CFG;
    ...
    $parameters = array (
        ...
        'pluginname' => 'local_glossary_wordimport', // Include plugin name to control image data handling inside XSLT.
    ...
    if (!($xsltoutput = xslt_process($xsltproc, $tempwordmlfilename, $word2xmlstylesheet1, null, null, $parameters))) {
        ...
        throw new moodle_exception('transformationfailed', 'local_glossary_wordimport', $tempwordmlfilename);
    }
    local_glossary_wordimport_debug_unlink($tempwordmlfilename);
    ...
    if (!($xsltoutput = xslt_process($xsltproc, $tempxhtmlfilename, $word2xmlstylesheet2, null, null, $parameters))) {
        ...
        throw new moodle_exception('transformationfailed', 'local_glossary_wordimport', $tempxhtmlfilename);
    }
    local_glossary_wordimport_debug_unlink($tempxhtmlfilename);
